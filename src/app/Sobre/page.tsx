    ...
    <div className="mt-14 h-[calc(100vh-3rem)]  overflow-y-auto overflow-x-hidden">
      ...
      <div className="  flex flex-col justify-center items-center mt-28 ">
        <div className=" flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="w-3/4 md:w-2/5 p-6 flex flex-col">
            ...
            <p className="text-justify mt-3">
              Desenvolvedora Fullstack, atualmente estudante de Sistemas de
              Informação na Universidade do Estado da Bahia (UNEB). Experiência
              com desenvolvimento web utilizando React, Next.js, Spring Boot e
              Laravel, além de conhecimentos em bancos de dados relacionais e
              não relacionais. Também já fui bolsista de Iniciação Científica no
              Grupo de Pesquisa em Bioinformática e Biologia Computacional
              (G2BC), atuando com análise de dados e desenvolvimento de scripts
              para apoio à pesquisa científica. Atualmente sou voluntária do
              projeto web, IaEditais da Fiocruz. Sou uma pessoa comunicativa,
              determinada e com perfil de liderança.{" "}
            </p>
        ...
        <div className=" lg:w-3/4 p-6 flex flex-col">
          <h2 className=" mt-6 text-center text-2xl md:text-5xl font-mono">
          ...
          <Timeline
            data={[
              {
                title:
                  "Fiocruz projeto IaEditais - Voluntária em Desenvolvimento WebFullStack",
                content: (
                  <div>
                    <h1 className="font-bold">MAIO 2025 - ATUALMENTE</h1> <br />
                    <p className="text-lg text-justify">
                      Atuo como desenvolvedora fullstack voluntária no projeto
                      IaEditais, iniciativa da Fiocruz. No frontend, implemento
                      módulos usando React, Next.js, TypeScript e Tailwind,
                      seguindo boas práticas e padrões de arquitetura. No
                      backend, contribuo em funcionalidades desenvolvidas com
                      FastAPI, SQLAlchemy e APIs REST, auxiliando na modelagem
                      de dados e integrações. Também participei da prototipação
                      de alta fidelidade no Figma e utilizo Git/GitHub no fluxo
              ...
              },
              {
                ...
                content: (
                  <div>
                    ...
                    <p className="text-lg text-justify">
                      Pesquisa interdisciplinar analisando dados genômicos,
                      epidemiológicos e climáticos do vírus da dengue (DENV) na
                      Bahia, focando em padrões de incidência e fatores de
                      risco. As atividades incluem coleta, organização e análise
                      de dados com modelos de séries temporais, reforçando
                      habilidades em ciência de dados, estatística e
                      programação, integrando Sistemas de Informação à
                      bioinformática e saúde pública.
                    </p>
                  </div>
                ),
              },
        ...
        <div className="flex flex-1 gap-5 m-4 mb-14">
          <a href="https://www.linkedin.com/in/alana-abreu/" target="_blank">
            <img
              ...
              alt="linkedin"
              className="md:h-14 md:w-14 transition-transform duration-300 ease-in-out transform hover:scale-125"
            />
          </a>
